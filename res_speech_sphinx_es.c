...
#define AST_MODULE "speech_sphinx_es"
...
static int load_module(void)
{
	...
	struct ast_config *conf = ast_config_load("sphinx_es.conf", config_flags);
	char const *value;

	if (conf == NULL) {
		ast_log(LOG_ERROR, "Unable to load sphinx_es.conf\n");
